...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => <div ref={ref} className={cn("rounded-2xl bg-card text-card-foreground shadow-[0_18px_50px_-34px_rgba(15,23,42,0.55)]", className)} {...props} />)
